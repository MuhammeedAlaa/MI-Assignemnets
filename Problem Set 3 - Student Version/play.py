...
def create_agent(args: argparse.Namespace):
    ...
    if args.model: agent.load(args.model)
...
def main(args: argparse.Namespace):
    ...
    agent = create_agent(args) # Create the requested agent
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent", "-a", default="human",
                        choices=['human', 'value_iteration', 'sarsa', 'q_learning', 'q_learning_approx', 'random'],
