...
def train_value_iteration(args: argparse.Namespace):
    ...
    # Apply value iteration for the givent number of iterations 
...
if __name__ == "__main__":
    ...
    parser.add_argument("agent", type=str, choices=["value_iteration", "sarsa", "q_learning", "q_learning_approx"])
